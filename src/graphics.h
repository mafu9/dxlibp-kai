...
//適当
#define RGBA(a, b, g, r) (((u32)(a) << 24)|((u32)(b) << 16)|((u32)(g) << 8)|(u32)(r))
#define RGB(r,g,b)		RGBA(0xFF, b, g, r)

#define R_U32(color)	((u32)color & 0xff)
#define G_U32(color)	(((u32)color >> 8) & 0xff)
#define B_U32(color)	(((u32)color >> 16) & 0xff)
#define A_U32(color)	(((u32)color >> 24) & 0xff)
...
/* defined in savescreen.c */
extern JPEGSETTING dxpjpegsetting;
...
extern const char jpeg_marker[9][2];
